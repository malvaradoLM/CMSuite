...
namespace RedCoForm
{
    public partial class frmPrincipal : DevExpress.XtraBars.Ribbon.RibbonForm, IMessageFilter
    {
        ...
        private void frmPrincipal_Load(object sender, EventArgs e)
        {
            ...
            rbPrincipal.Images = RedCoForm.Data.DataModule.Images16;
            rbPrincipal.LargeImages = RedCoForm.Data.DataModule.Images48;
        ...
        {
            ModuleInfoCollection.ShowModuleByName("CatalogoPedido", this);
            bvcMenuPrincipal.Close();
        }

        private void tiVehiculo_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
        ...
        {
            ModuleInfoCollection.ShowModuleByName("CatalogoTerminal", this);
            bvcMenuPrincipal.Close();
        }
        ...
        private void tileItem40_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
            ModuleInfoCollection.ShowModuleByName("CatalogoBanco", this);
            bvcMenuPrincipal.Close();
        }
